...
/**
 * @internal
 * Constants for all properties available in zenith.yml.
 * This is generated by build/codegen/zenith-yml-property-consts.php.
...
final class YmlServerProperties{
	...
	public const RESOURCE_PACKS = 'resource-packs';
	public const RESOURCE_PACKS_CDN_URLS = 'resource-packs.cdn-urls';
	public const RESOURCE_PACKS_FORCE_RESOURCES = 'resource-packs.force-resources';
	public const SERVER = 'server';
	public const SERVER_AUTO_SAVE = 'server.auto-save';
	public const SERVER_DIFFICULTY = 'server.difficulty';
	public const SERVER_ENABLE_IPV6 = 'server.enable-ipv6';
	public const SERVER_ENABLE_QUERY = 'server.enable-query';
	public const SERVER_FORCE_GAMEMODE = 'server.force-gamemode';
	public const SERVER_GAMEMODE = 'server.gamemode';
	public const SERVER_GENERATOR_SETTINGS = 'server.generator-settings';
	public const SERVER_HARDCORE = 'server.hardcore';
	public const SERVER_LANGUAGE = 'server.language';
	public const SERVER_LEVEL_NAME = 'server.level-name';
	public const SERVER_LEVEL_SEED = 'server.level-seed';
	public const SERVER_LEVEL_TYPE = 'server.level-type';
	public const SERVER_MAX_PLAYERS = 'server.max-players';
	public const SERVER_MOTD = 'server.motd';
	public const SERVER_PVP = 'server.pvp';
	public const SERVER_SERVER_IP = 'server.server-ip';
	public const SERVER_SERVER_IPV6 = 'server.server-ipv6';
	public const SERVER_SERVER_PORT = 'server.server-port';
	public const SERVER_SERVER_PORTV6 = 'server.server-portv6';
	public const SERVER_VIEW_DISTANCE = 'server.view-distance';
	public const SERVER_WHITE_LIST = 'server.white-list';
	public const SERVER_XBOX_AUTH = 'server.xbox-auth';
