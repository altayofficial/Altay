...
final class ArrowPrimitiveShape extends PrimitiveShape{

	public const DEFAULT_SEGMENTS = 4;

	public function __construct(
		int $networkId,
		Vector3 $location,
		private Vector3 $lineEndLocation,
		private ?float $arrowHeadLength = null,
		private ?float $arrowHeadRadius = null,
	...
	protected function getType() : PrimitiveShapeType{ return PrimitiveShapeType::ARROW; }

	public function toShapeData() : PacketShapeData{
		return PacketShapeData::arrow($this->networkId, $this->location, $this->lineEndLocation, null, $this->color, $this->arrowHeadLength, $this->arrowHeadRadius, $this->segments, $this->dimensionId, $this->attachedToEntityId);
	}
}
