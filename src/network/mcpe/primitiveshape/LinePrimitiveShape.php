...
final class LinePrimitiveShape extends PrimitiveShape{
	...
	protected function getType() : PrimitiveShapeType{ return PrimitiveShapeType::LINE; }

	public function toShapeData() : PacketShapeData{
		return PacketShapeData::line($this->networkId, $this->location, $this->lineEndLocation, $this->color, $this->dimensionId, $this->attachedToEntityId);
	}
}
