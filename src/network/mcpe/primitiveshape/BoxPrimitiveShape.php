...
final class BoxPrimitiveShape extends PrimitiveShape{
	...
	protected function getType() : PrimitiveShapeType{ return PrimitiveShapeType::BOX; }

	public function toShapeData() : PacketShapeData{
		return PacketShapeData::box($this->networkId, $this->location, $this->boxBound, $this->scale, $this->color, $this->dimensionId, $this->attachedToEntityId);
	}
}
