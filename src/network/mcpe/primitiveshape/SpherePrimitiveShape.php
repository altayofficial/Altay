...
final class SpherePrimitiveShape extends PrimitiveShape{
	...
	protected function getType() : PrimitiveShapeType{ return PrimitiveShapeType::SPHERE; }

	public function toShapeData() : PacketShapeData{
		return PacketShapeData::sphere($this->networkId, $this->location, $this->segments, $this->scale, $this->color, $this->dimensionId, $this->attachedToEntityId);
	}
}
